...
**15. ARM Cortex-A. ARM Cortex-A. Контролер на прекъсванията (GIC). Вграден логически анализатор (ELA). Moнитор на производителността (PMU).**  
==================================================== 
Въведение в ARM GIC. Фази на прекъсването. GIC и виртуализация. Въведение в ARM ELA. Инициализация на ARM ELA. Програмен модел на ARM ELA. Монитор на производителността (PMU).
